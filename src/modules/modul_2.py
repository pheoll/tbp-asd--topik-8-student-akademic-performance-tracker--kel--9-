...
def generate_mahasiswa(n: int = 60):
    ...
    for i in range(1, n + 1):
        ...
        mhs_list.append(bst_.Mahasiswa(
            nim=nim,
            nama=f'Mahasiswa-{i}',
            prodi=prodi,
            angkatan=angkatan
...
def inisialisasi_bst(n: int = 60) -> bst_.BSTMahasiswa:
    """
...
def cari_mahasiswa(bst: bst_.BSTMahasiswa, nim: str):
    """
...
def daftar_mahasiswa(bst: bst_.BSTMahasiswa) -> None:
    """
...
def filter_range_ipk(bst: bst_.BSTMahasiswa, low: float, high: float) -> None:
    """
